...
bool handle_ack_packet(AQ_Ack_Packet processedPacket)
{
	...
	case Master_2:
	case Master_3:
		TRACE("Received ACK from Master Device --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case Keypad_2:
	case Keypad_3:
		TRACE("Received ACK from Keypad --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;

	case DualSpaSideSwitch_InterfaceBoard:
		TRACE("Received ACK from Dual Spa Side Switch interface board --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		{
	...
	case SPA_Remote_2:
	case SPA_Remote_3:
		TRACE("Received ACK from SPA Remote --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case Aqualink_2:
	case Aqualink_3:
		TRACE("Received ACK from Aqualink --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case LX_Heater_2:
	case LX_Heater_3:
		TRACE("Received ACK from LX Heater --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		{
			HardwareDevice* this_device = (HardwareDevice*)malloc(sizeof(HardwareDevice));
			this_device->Info.gdi.Id = processedPacket.Destination;
	...
	case OneTouch_2:
	case OneTouch_3:
		TRACE("Received ACK from OneTouch --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case SWG_2:
	case SWG_3:
		TRACE("Received ACK from SWG --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case PC_Interface_2:
	case PC_Interface_3:
		TRACE("Received ACK from PC Interface --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case PDA_Remote_2:
	case PDA_Remote_3:
		TRACE("Received ACK from PDA Remote --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case Jandy_VSP_ePump_3:
		TRACE("Received ACK from Jandy VSP ePump --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case ChemLink_2:
	case ChemLink_3:
		TRACE("Received ACK from ChemLink --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	...
	case iAqualink_2:
	case iAqualink_3:
		TRACE("Received ACK from iAqualink --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;

	default:
		TRACE(" Received ACK from unknown device --> id: %#x, type: %#x, ack'd command: %#x", processedPacket.Destination, processedPacket.AckType, processedPacket.CommandBeingAcked);
		break;
	}
...
bool process_ack_packet(unsigned char* rawPacket, unsigned int length)
{
	...
	WARN_IF((AQ_ACK_PACKET_LENGTH < length), "ACK - packet length AS-READ is longer than expected...");
