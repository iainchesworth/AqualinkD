...
static cfg_opt_t _config_parameters_defaults[] =
{
	...
	CFG_STR("button_01_label", "NONE", CFGF_NONE),
	CFG_STR("button_02_label", "NONE", CFGF_NONE),
	CFG_STR("button_03_label", "NONE", CFGF_NONE),
	CFG_STR("button_04_label", "NONE", CFGF_NONE),
	CFG_STR("button_05_label", "NONE", CFGF_NONE),
	CFG_STR("button_06_label", "NONE", CFGF_NONE),
	CFG_STR("button_07_label", "NONE", CFGF_NONE),
	CFG_STR("button_08_label", "NONE", CFGF_NONE),
	CFG_STR("button_09_label", "NONE", CFGF_NONE),
	CFG_STR("button_10_label", "NONE", CFGF_NONE),
	CFG_STR("button_11_label", "NONE", CFGF_NONE),
	CFG_STR("button_12_label", "NONE", CFGF_NONE),
